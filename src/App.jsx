  ...
  return (
    ...
    <main>
      <div className="images">
        <img id="TommorrowLand"src="/modals/TommorrowLand.png" alt="" />
        <img id="Navy-pier"src="/modals/Navy-pier.png" alt="" />
        <img id="MSI-chicago"src="/modals/MSI-chicago.png" alt="" />
        <img id="Louise-phone"src="/modals/Louise-phone.png" alt="" />
        <img id="KIKI"src="/modals/KIKI.png" alt="" />
        <img id="Kennady"src="/modals/Kennady.png" alt="" />
        <img id="royal-opera"src="/modals/royal-opera.png" alt="" />
      </div>
      <Canvas 
      id="canvas-elem"
      style={{
    ...
    <section id='section-1' >
      <nav>
        ...
        <div className="nav-elem" id="showReel">
          <i className="ri-arrow-right-s-line"></i>Our Showreel</div>
        <div className="nav-elem">
    ...
    <section id='section-2' >
      <div className="titles">
        <div img-title="TommorrowLand"className="title">
        ...
        <div img-title="Louise-phone"className="title">
          <small>2020-ONGOING</small>
          <h1>This Was Louise's Phone</h1>
        </div>
        <div img-title="KIKI"className="title">
          <small>2020-ONGOING</small>
          <h1>KIKK Festival 2018</h1>
        </div>
        <div img-title="Kennady"className="title">
          <small>2020-ONGOING</small>
    ...
    <section id='section-3' >
     ...
     <div id="section-last">
      ...
      <div className="footerContent">
        <p>We'd love to hear you from</p>
        <span className="line"></span>
        <p className="dogstudio">biz@dogstudio.be</p>
      </div>
